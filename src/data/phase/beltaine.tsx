...
export const beltaine = (): PhaseDTO => {
  const startDate = '2023-02-01T12:00:00Z'
  const endDate = '2023-02-28T23:59:00Z'
  return {
    number: 3,
    phaseName: 'beltaine',
    phaseDescription:
        ...
        taskContent: [
          {
            ...
            contentDescription: (
              <p>
                ...
                proposal is accepted, Druids need to perform the update. To achieve this task you
                need to make sure your node is updated on time and doesn&apos;t miss blocks.
              </p>
            )
          },
          {
          ...
          },
          {
            ...
            contentDescription: (
              <p>
                Points will be awarded according to your uptime within the hour following the
                targeted upgrade height.
              </p>
            )
          },
          {
